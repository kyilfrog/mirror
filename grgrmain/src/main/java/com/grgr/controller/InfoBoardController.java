...
public class InfoBoardController {
	...
	public String list(SearchCondition searchCondition,HttpSession session, Model model) {
		...
		@GetMapping("/read")
		public String infoBoardRead(@RequestParam int infoBno, SearchCondition searchCondition,HttpSession session, Model model) {
			try {
				searchCondition.setLoginLocation(extractLoginLocation(session));
	...
	public String infoBoardModify(InfoBoard infoBoard, @RequestParam(value = "files", required = false) List<MultipartFile> files) 
			throws WriteNullException, FileUploadFailException, IOException{
