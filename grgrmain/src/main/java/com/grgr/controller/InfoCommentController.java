...
public class InfoCommentController {
	...
	public ResponseEntity<String> infoCommentAdd(@RequestBody InfoComment infoComment, @PathVariable int infoBno, HttpSession session) throws CommentInsertException {
	...
	public ResponseEntity<String> infoCommentModify(@PathVariable int infoCommentNo, @RequestBody InfoComment infoComment, HttpSession session) 
	...
	public ResponseEntity<String> infoCommentRemove(@PathVariable int infoCommentNo, HttpSession session ) throws CommentRemoveException {
		int loginUno = (int)session.getAttribute("loginUno"); 
	...
	public ResponseEntity<String> infoCommentBlind(@PathVariable int infoCommentNo, HttpSession session ) throws CommentBlindException {
		int loginUno = (int)session.getAttribute("loginUno"); 
